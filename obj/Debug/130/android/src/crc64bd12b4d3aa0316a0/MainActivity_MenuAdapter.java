...
public class MainActivity_MenuAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Tabela_FIPE.MainActivity+MenuAdapter, Tabela-FIPE", MainActivity_MenuAdapter.class, __md_methods);
	}


	public MainActivity_MenuAdapter ()
	{
		super ();
		if (getClass () == MainActivity_MenuAdapter.class) {
			mono.android.TypeManager.Activate ("Tabela_FIPE.MainActivity+MenuAdapter, Tabela-FIPE", "", this, new java.lang.Object[] {  });
		}
	}
